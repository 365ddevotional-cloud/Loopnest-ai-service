...
app.get("/health", (req, res) => {
  res.json({ status: "ok", service: "loopnest", timestamp: new Date().toISOString() });
});
...
app.post("/generate-puzzle", (req, res) => {
  ...
  const puzzleTemplates = [
    ...
    {
      type: "match",
      prompt: "Match the verse to its book: 'In all things God works for the good'",
      answer: "Romans",
      hint: "Romans 8:28",
    },
    {
      type: "match",
      prompt: "Match the verse to its book: 'The joy of the Lord is your strength'",
      answer: "Nehemiah",
      hint: "Nehemiah 8:10",
    },
  ];
