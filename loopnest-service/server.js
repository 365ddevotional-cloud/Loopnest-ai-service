...
const SCRIPTURE_POOL = [
  ...
  {
    text: "He who began a good work in you will complete it",
    ref: "Philippians 1:6",
  },
...
app.post("/generate-quiz", (req, res) => {
  ...
  const quizTemplates = [
    {
      question:
        "Which book of the Bible contains the verse 'Trust in the Lord with all your heart'?",
    ...
    {
      question:
        "'Be strong and courageous' was spoken to which biblical figure?",
    ...
    {
      question:
        "Which verse says 'For God so loved the world that He gave His only Son'?",
    ...
    {
      question:
        "'No weapon formed against you shall prosper' is found in which book?",
    ...
    {
      question:
        "'Those who hope in the Lord will renew their strength' is from which chapter?",
...
app.post("/generate-puzzle", (req, res) => {
  ...
  const puzzleTemplates = [
    {
      type: "fill-in-blank",
      prompt: "Trust in the ____ with all your heart",
      answer: "Lord",
      hint: "Proverbs 3:5",
    },
    {
      type: "fill-in-blank",
      prompt: "I can do all things through ____ who strengthens me",
      answer: "Christ",
      hint: "Philippians 4:13",
    },
    {
      type: "fill-in-blank",
      prompt: "The Lord is my ____; I shall not want",
      answer: "shepherd",
      hint: "Psalm 23:1",
    },
    {
      type: "fill-in-blank",
      prompt: "Be strong and ____",
      answer: "courageous",
      hint: "Joshua 1:9",
    },
    {
      type: "fill-in-blank",
      prompt: "Do not ____, for I am with you",
      answer: "fear",
      hint: "Isaiah 41:10",
    },
    {
      type: "unscramble",
      prompt: "Unscramble: ACGER",
      answer: "GRACE",
      hint: "2 Corinthians 12:9",
    },
    {
      type: "unscramble",
      prompt: "Unscramble: HFAIT",
      answer: "FAITH",
      hint: "Hebrews 11:1",
    },
    {
      type: "unscramble",
      prompt: "Unscramble: EACEP",
      answer: "PEACE",
      hint: "John 14:27",
    },
    {
      type: "match",
      prompt:
        "Match the verse to its book: 'In all things God works for the good'",
      answer: "Romans",
      hint: "Romans 8:28",
    },
    {
      type: "match",
      prompt:
        "Match the verse to its book: 'The joy of the Lord is your strength'",
      answer: "Nehemiah",
      hint: "Nehemiah 8:10",
    },
  ];
