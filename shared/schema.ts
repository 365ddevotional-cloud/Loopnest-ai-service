...
export const churches = pgTable("churches", {
  ...
  // Platform governance
  platformStatus: text("platform_status").notNull().default("approved"), // draft | submitted | pending_review | approved | rejected | suspended | archived
...
export const PLATFORM_STATUS_VALUES = ["draft", "submitted", "pending_review", "approved", "rejected", "suspended", "archived"] as const;
...
export const songUploadDefaults = pgTable("song_upload_defaults", {
  ...
  ytPrivacy: text("yt_privacy").default("private"),
  ytMadeForKids: boolean("yt_made_for_kids").default(false),
  ytSyntheticContent: boolean("yt_synthetic_content").default(false),
  ytCategoryId: text("yt_category_id").default("10"),
  ytLanguage: text("yt_language").default("en"),
  ytLicense: text("yt_license").default("youtube"),
  ytAllowEmbedding: boolean("yt_allow_embedding").default(true),
  ytPublicStats: boolean("yt_public_stats").default(true),
  ytNotifySubscribers: boolean("yt_notify_subscribers").default(true),
  ytDefaultTags: text("yt_default_tags"),
  ytDescriptionFooter: text("yt_description_footer"),
  ytThumbnailChoice: text("yt_thumbnail_choice").default("song_cover"),
  ytSchedulingTimezone: text("yt_scheduling_timezone").default("America/Chicago"),
  ytSchedulingBehavior: text("yt_scheduling_behavior").default("immediate"),
  updatedAt: timestamp("updated_at").defaultNow(),
});
...
export const youtubeSongUploads = pgTable("youtube_song_uploads", {
  ...
  syntheticContent: boolean("synthetic_content"),
  categoryId: text("category_id"),
  tags: text("tags"),
  license: text("license"),
  allowEmbedding: boolean("allow_embedding"),
  publicStats: boolean("public_stats"),
